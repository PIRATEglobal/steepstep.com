...
| Sport hub | `images/optimized/movement-1200.webp` | Connects sport pages to movement observation before the visitor chooses a discipline. | Eager on hub, 1200px WebP, wide crop. Powerflow rights still need photographer and model confirmation. |
